                ...
                <div className="md:col-span-2 space-y-12">
                    ...
                    <section className="border-t border-white/5 pt-8">
                        ...
                        <div className="mt-6 flex items-center gap-6">
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-600">Open in:</span>
                            <div className="flex items-center gap-4">
                                {extraInfo.appleMusicUrl && (
                                    <a href={extraInfo.appleMusicUrl} target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 translation hover:scale-110 active:scale-95 duration-200">
                                        <img src="/apple-music.png" alt="Apple Music" className="w-5 h-5 object-contain" />
                                    </a>
                                )}
                                <a href={extraInfo.spotifyUrl} target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 translation hover:scale-110 active:scale-95 duration-200">
